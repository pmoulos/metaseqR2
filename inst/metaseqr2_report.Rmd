...
<!---
<button id="generate_mds" on>Generate MDS!</button>
<div class="hc-rect-small" id="mds_container"></div>
<script>
$("#generate_mds").click(function() {
	console.log(MDS_JSON);
	$('#mds_container').highcharts(MDS_JSON);
})
</script>
-->
...
if ("boxplot" %in% qcPlots) {
	...
	cat("<div class=\"hc-rect-small\" id=\"boxplot_unorm_container\"></div>",
		sep="")
	cat("<div class=\"hc-rect-small\" id=\"boxplot_norm_container\"></div>",
		sep="")
...
if ("gcbias" %in% qcPlots) {
	...
	cat("<div class=\"figure-hint\">",reportMessages$explain$gcbias,
		"</br></br></div>",sep="")
	cat("<div class=\"hc-rect-small\" id=\"gcbias_unorm_container\"></div>",
		sep="")
	cat("<div class=\"hc-rect-small\" id=\"gcbias_norm_container\"></div>",
		sep="")
...
if ("lengthbias" %in% qcPlots) {
	...
	cat("<div class=\"figure-hint\">",reportMessages$explain$lengthbias,
		"</br></br></div>",sep="")
	cat("<div class=\"hc-rect-small\" id=\"lengthbias_unorm_container\"></div>",
		sep="")
	cat("<div class=\"hc-rect-small\" id=\"lengthbias_norm_container\"></div>",
		sep="")
...
if ("meandiff" %in% qcPlots) {
	...
	cat("<div class=\"hc-rect-small\" id=\"meandiff_unorm_container\"></div>",
		sep="")
