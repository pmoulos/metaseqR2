...
for (cnt in contrast) {
	...
	print(htmltools::tagList(tags$div(class="detable-container",DT::datatable(
		reportTables[[cnt]],
		rownames=FALSE,
		#width=1020,
		style="bootstrap",
		...
		names(reportTables[[cnt]])[fi],
		backgroundColor=styleInterval(brks,clrs),
		fontWeight="bold",
		color="#FFFFFF"
	) %>% formatStyle(
		names(reportTables[[cnt]])[pi],
		backgroundColor=styleColorBar(range(-10*log10(
			reportTables[[cnt]][,pi])),"lightblue"),
		fontWeight="bold",
		backgroundSize="98% 88%",
		backgroundRepeat="no-repeat",
		backgroundPosition="center"
	) %>% formatStyle(
		names(reportTables[[cnt]])[di],
		backgroundColor=styleColorBar(range(-10*log10(
			reportTables[[cnt]][,di])),"lightgreen"),
		fontWeight="bold",
		backgroundSize="98% 88%",
		backgroundRepeat="no-repeat",
		backgroundPosition="center"
