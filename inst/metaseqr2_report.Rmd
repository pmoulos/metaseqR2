...
if (exportCountsTable) {
	cat("</br><div style=\"background-color:#D2EBFF; border-style:solid;",
		"border-color:#8F8BFF; border-width:1px; width:400px; padding:10px;\">",
		sep="")
...
if (length(qcPlots) > 0) {
	...
	cat("<div id=\"get_figures\" class=\"figure-hint\">")
