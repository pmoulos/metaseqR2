...
### `r if ("boxplot" %in% qcPlots) 'Boxplots'`
...
### `r if ("gcbias" %in% qcPlots) 'GC bias'`
...
### `r if ("lengthbias" %in% qcPlots) 'Length bias'`
...
### `r if ("meandiff" %in% qcPlots) 'Mean-Difference'`
...
### `r if ("meanvar" %in% qcPlots) 'Mean-Variance'`
...
### `r if ("rnacomp" %in% qcPlots) 'RnaComp'`
...
### `r if ("volcano" %in% qcPlots) 'Volcano'`
...
### `r if ("deheatmap" %in% qcPlots) 'Heatmap'`
