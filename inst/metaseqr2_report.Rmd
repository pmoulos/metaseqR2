...
if (trackInfo$stranded) {
    ...
    minusLinks <- paste0(trackInfo$urlBase,"/",o,"/",samples,"_minus.bigWig")
    ...
    cat("<br/>")
    cat("You can manually load bigWig files in UCSC Genome Browser using the ",
        "following track lines:<br/><br/>")
    cat("<pre><code>")
