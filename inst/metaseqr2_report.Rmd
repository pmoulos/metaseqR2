...
if (offlineReport) {
	...
	cat("<script type=\"text/javascript\" src=\"js/export-data.js\"></script>",
		sep="")
	cat("<script src=\"js/dexie.min.js\"></script>",sep="")
...
The following figures summarize the quality control steps and assessment 
performed by the ```metaseqr2``` pipeline. Each figure category is accompanied
by an explanatory text. All figures are interactive wih additional controls on
...
if (exportCountsTable) {
	cat("<br/><div class=\"figure-hint link-box\">")
	if (file.exists(file.path(PROJECT.PATH[["lists"]],
