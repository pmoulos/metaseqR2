...
if ("biodist" %in% qcPlots) {
	...
	cat("<h4>Chromosome distribution of differentially expressed ",transLevel,
		"s</h4>",sep="")
	cat("<div class=\"hc-rect-sm\" id=\"chromosome_biodist_container\"></div>",
		sep="")
	...
	cat("<h4>Biotype distribution of differentially expressed ",transLevel,
		"s</h4>",sep="")
	cat("<div class=\"hc-rect-sm\" id=\"biotype_biodist_container\"></div>",
		sep="")
...
if ("venn" %in% qcPlots) {
	...
	preJson <- makeJVennData(cpList[[1]],pcut=pcut)
	
	cat("<h4><strong>Venn diagram of differentially expressed ",transLevel,
		"s</strong></h4>",sep="")
	cat("<div class=\"figure-hint\">",reportMessages$explain$venn,
	    "<br/><br/></div>",sep="")
	cat("<div id='jvenn_container'></div>")
	
	cat("<script>$('#jvenn_container').jvenn(",toJSON(preJson,auto_unbox=TRUE),
		");</script>",sep="")
}
```
