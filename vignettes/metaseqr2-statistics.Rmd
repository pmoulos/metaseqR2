...
result <- metaseqr2(
	...
	qcPlots=c(
		...
		"meanvar","rnacomp","deheatmap","volcano","mastat","biodist","venn"
	),
	figFormat=c("png","pdf"),
...
download.file(lnk,outDir4)
unzip(file.path(outDir4,"3i4_data.zip"),exdir=outDir4,junkpaths=TRUE)

targetsDf <- data.frame(
	samplename=c("CON1","CON2","DOX1","DOX2"),
	filename=dir(outDir4,pattern=".bam",full.names=TRUE),
