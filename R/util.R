...
getWeights2 <- function(org=c("human","chimpanzee","mouse","fruitfly",
    "arabidopsis","rat")) {
    org <- tolower(org)
    checkTextArgs("org",org,c("human","chimpanzee","mouse","fruitfly",
        "arabidopsis","rat"))
            ...
            switch(method,
                ...
                deseq2 = {
                    valid <- names(argList) %in% c("tidy","fitType","maxit","quiet",
                        ...
                        #"betaPriorVar","modelMatrixType", #removed because they are also removed in get defaults
                        "betaTol","useOptim","useT","df","useQR","lfcThreshold",
                        "altHypothesis","independentFiltering","alpha","pAdjustMethod",
                        "format","addMLE","parallel","BPPARAM")
                    not.valid <- which(!valid)
                },
                edger = {
                ...
                references=list(
                    ...
                    stat=list(
                        ...
                        absseq=paste("Wentao Yang, Philip Rosenstiel and",
                             "Hinrich Schulenburg: ABSSeq: a new RNA-Seq",
                             "analysis method based on modelling absolute",
                             "expression differences BMC Genomics 2016; 17: 541"),
                        dss=paste("Hao Wu, Chi Wang, Zhijin Wu (2013):",
                             "A new shrinkage estimator for dispersion improves",
                             "differential expression detection in RNA-seq data.",
                             "Biostatistics, 14(2):232-43.",
